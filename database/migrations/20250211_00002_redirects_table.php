...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('redirects', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->boolean('active')->default(true)->nullable(false)->comment('this field is active or not?');
            ...
            $table->boolean('redirect')->default(true)->nullable(false)->comment('if true then URI must be redirect to URL else it must be microsite');
            $table->string('url', 512)->nullable(false)->comment('URL yang asli');
            // table comment
